...
for file in sorted(os.listdir('C:/Users/BIE/Desktop/Python/MLA/MLA_2122/data')):
    ...
    timestamp_transfer_date= data.timestamp_transfer.str[:2] #Just the Days of the Timestamp
    ...
    timestamp_transfer_hours = data.timestamp_transfer.str[-8:] #Just the Time of the Timestamp
    ...
    timestamp_measure_position_date= data.timestamp_measure_position.str[:2] #Just the Days of the Timestamp
    ...
    timestamp_measure_position_hours = data.timestamp_measure_position.str[-8:] #Just the Time of the Timestamp
